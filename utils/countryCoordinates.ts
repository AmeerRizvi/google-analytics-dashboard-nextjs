// A mapping of country names to their approximate coordinates (latitude, longitude)
...
// Function to get coordinates for a country, with fallback to default if not found
